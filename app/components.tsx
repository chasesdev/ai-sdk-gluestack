...
export default function ComponentsPage() {
  ...
  const sections = [
    ...
    },
    {
      id: 'ai-sdk',
      title: 'AI Components',
      description: 'AI SDK components and workflow visualization',
    },
  ]
            ...
            <Animated.View entering={FadeInDown.delay(100).duration(400)}>
              {tocExpanded ? (
                <Box sx={{ marginBottom: '$4' }}>
                  ...
                  <VStack
                    space="sm"
                    sx={{ paddingVertical: '$2', marginTop: '$2' }}
                  >
                    ...
                    <AccordionContent>
                      <AccordionContentText>
                        ...
                        >
                          <DemoCard
                            title="Heading & Text"
                            description="Text hierarchy components"
                          >
                            <VStack space="md">
                              <Heading size="2xl" style={{ color: textColor }}>
                                Heading 2XL
                              </Heading>
                    ...
                    <AccordionContent>
                      <AccordionContentText>
                          ...
                          >
                            ...
                            >
                              ...
                              <ModalContent>
                                ...
                                <ModalBody>
                                  <Text>
                                    This is a modal dialog. It overlays the main
                                    content and can contain any components.
                                  </Text>
                                </ModalBody>
                                <ModalFooter>
                                  <HStack space="sm">
                          ...
                          >
                            <Accordion>
                              <AccordionItem value="item-1">
                                ...
                                <AccordionContent>
                                  <AccordionContentText>
                                    Gluestack UI is a universal UI library that
                                    provides beautifully designed, accessible
                                    components for React Native and web
                                    applications.
                                  </AccordionContentText>
                                </AccordionContent>
                              </AccordionItem>
                              <AccordionItem value="item-2">
                                ...
                                <AccordionContent>
                                  <AccordionContentText>
                                    Yes! All components are built with
                                    accessibility in mind and follow WAI-ARIA
                                    standards.
                                  </AccordionContentText>
                                </AccordionContent>
                              </AccordionItem>
                              <AccordionItem value="item-3">
                                ...
                                <AccordionContent>
                                  <AccordionContentText>
                                    Absolutely! Gluestack UI provides a powerful
                                    theming system that lets you customize
                        ...
                        >
                          ...
                          <DemoCard
                            title="Icons"
                            description="Various icon components"
                          >
                            <HStack
                              space="lg"
                              className="items-center justify-around"
